// TODO: Remove this module helper
...
const matchPassValidation = (type: PassValidationType) => {
  ...
  return !regex.test(type) ? validationMessages[type] : "Unknown validation error";
}
